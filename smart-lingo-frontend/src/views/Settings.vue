  ...
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
      <div class="p-6 border-b border-gray-100 dark:border-gray-700">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white">个人资料</h3>
        <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">管理您的个人信息和账户安全</p>
      </div>
      <div class="p-6 space-y-6">
        <div class="flex items-center space-x-6">
          <div class="w-20 h-20 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center overflow-hidden">
             <img v-if="form.avatar" :src="getAvatarUrl(form.avatar)" class="w-full h-full object-cover" alt="Avatar" />
             <span v-else class="text-indigo-600 dark:text-indigo-300 text-2xl font-bold">U</span>
          </div>
          <div>
            <el-button type="primary" size="small" @click="triggerFileInput">更换头像</el-button>
            <el-button size="small" class="dark:bg-gray-700 dark:text-white dark:border-gray-600">删除</el-button>
            <input type="file" ref="fileInput" class="hidden" @change="handleFileChange" accept="image/*">
          </div>
        </div>
        
        <el-form label-position="top" class="max-w-md">
          <el-form-item label="昵称" class="dark:text-white">
            <el-input v-model="form.nickname" placeholder="请输入昵称" />
          </el-form-item>
          <el-form-item label="每组单词数量" class="dark:text-white">
             <div class="flex items-center space-x-4">
                <el-input-number v-model="form.wordsPerGroup" :min="5" :max="50" :step="5" />
                <span class="text-sm text-gray-500 dark:text-gray-400">建议: 10-20个/组</span>
             </div>
          </el-form-item>
        </el-form>
      </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
      <div class="p-6 border-b border-gray-100 dark:border-gray-700">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white">偏好设置</h3>
      </div>
      <div class="p-6">
        <div class="flex items-center justify-between py-3">
          <div>
            <div class="font-medium text-gray-700 dark:text-gray-200">深色模式</div>
            <div class="text-sm text-gray-500 dark:text-gray-400">开启护眼深色主题</div>
          </div>
    ...
    <div class="flex justify-end space-x-4">
      <el-button class="dark:bg-gray-700 dark:text-white dark:border-gray-600">取消</el-button>
